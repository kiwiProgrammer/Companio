...
import com.companio.greet.GreetingActivity;
...
public class ScannerActivity extends AppCompatActivity implements SurfaceHolder.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContentView.getHolder().setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
        ...
        findViewById(R.id.dummy_button).setOnTouchListener(new View.OnTouchListener() {
                                                               ...
                                                               public boolean onTouch(View view, MotionEvent motionEvent) {
                                                                   if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
                                                                       ...
                                                                       Intent intent = new Intent(me.getApplicationContext(), GreetingActivity.class);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            mCamera.setPreviewDisplay(mContentView.getHolder());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
